...
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "../../..")))
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "../../../..")))
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "../server_ernie")))
...
if os.path.exists('conf/logger.conf'):
    ...
    logging.config.fileConfig('../../../../conf/logger.conf')
elif os.path.exists('/ernie/server_ernie/conf/logger.conf'):
    logging.config.fileConfig('/ernie/server_ernie/conf/logger.conf')
else:
